...
const HorizontalScrollCard = ({data = [],heading,trending,media_type}) => {
  ...
  return (
    ...
    <h2 className='text-lg font-bold lg:text-2xl mb-3 text-white capitalize'>{heading}</h2>
     <div className='relative'>
     <div ref={containerRef} className='grid grid-cols-[repeat(auto-fit,230px)] grid-flow-col gap-6 overflow-x-scroll z-10 relative overflow-hidden scroll-smooth transition-all scrolbar-none'>
  {
    data.map((data,index)=>{
        return(
